...
class ReclamationControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            'reclamation[contenue]' => 'Testing',
            'reclamation[id_utilisateur]' => 'Testing',
            'reclamation[statut]' => 'Testing',
            'reclamation[date_en_jour]' => 'Testing',
        ]);
    ...
    public function testShow(): void
    {
        ...
        $fixture->setDate_en_jour('My Title');
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            'reclamation[contenue]' => 'Something New',
            'reclamation[id_utilisateur]' => 'Something New',
            'reclamation[statut]' => 'Something New',
            'reclamation[date_en_jour]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getDate_en_jour());
    }
