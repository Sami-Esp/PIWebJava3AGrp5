...
public function findByCombinedSearch(string $nomSearch, string $lieuSearch): array
    {
        ...
        if ($lieuSearch) {
            $queryBuilder->andWhere('e.lieu LIKE :lieuSearch')
                ->setParameter('lieuSearch', '%' . $lieuSearch . '%');
        }
